...
namespace Dash {
    ...
    public partial class EmployeeDataSet : global::System.Data.DataSet {
        ...
        public partial class EmployeeDataTable : global::System.Data.TypedTableBase<EmployeeRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public EmployeeRow AddEmployeeRow(string FirstName, string LastName, string Position, System.DateTime HiredDate, int Salary, string Department) {
...
namespace Dash.EmployeeDataSetTableAdapters {
    ...
    public partial class EmployeeTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Employee] ([FirstName], [LastName], [Position], [HiredDate], [" +
                "Salary], [Department]) VALUES (@FirstName, @LastName, @Position, @HiredDate, @Sa" +
                "lary, @Department)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Employee] SET [FirstName] = @FirstName, [LastName] = @LastName, [Po" +
                "sition] = @Position, [HiredDate] = @HiredDate, [Salary] = @Salary, [Department] " +
                "= @Department WHERE (([Id] = @Original_Id))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings["DashDBConnectionString1"].ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, FirstName, LastName, Position, HiredDate, Salary, Department FROM dbo." +
                "Employee";
        ...
        public virtual int Insert(string FirstName, string LastName, string Position, System.DateTime HiredDate, int Salary, string Department) {
            if ((FirstName == null)) {
            ...
            this.Adapter.InsertCommand.Parameters[3].Value = ((System.DateTime)(HiredDate));
        ...
        public virtual int Update(string FirstName, string LastName, string Position, System.DateTime HiredDate, int Salary, string Department, int Original_Id) {
            if ((FirstName == null)) {
                throw new global::System.ArgumentNullException("FirstName");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[3].Value = ((System.DateTime)(HiredDate));
